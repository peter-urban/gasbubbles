...
This subpackage provides implementations of various bubble acoustic backscatter models:
...
def plot_bs_comparison(
    ...
    models : list[str] | None
        ...
        'anderson', 'ainslie_leighton', 'stanton'. If None, plots all models.
